...
define('GENERATOR_META', 'koeZion CMS 2.0 - CMS OPENSOURCE PHP');
define('GENERATOR_LINK', '<p id="powered_by" style="position:absolute;width:80px;bottom:5px;right:5px;font-size:8px;margin-bottom:0;height:15px"><a href="http://www.koezion-cms.com" title="koéZionCMS - CMS opensource PHP" style="width:80px;height:15px;text-indent:-9999px;display:block">propulsé par koéZionCMS - CMS opensource PHP</a></p>');
