												...
												},
												{
													...
													setup : function( type, element )
													{
														if ( type == IMAGE )
														{
															...
															value = marginLeftPx;
															isNaN( parseInt( value, 10 ) ) && ( value = element.getAttribute( 'gspace' ) );
													...
													commit : function( type, element, internalCommit )
													{
														...
														if ( type == IMAGE || type == PREVIEW )
														{
															...
															if ( !internalCommit && type == IMAGE )
																element.removeAttribute( 'gspace' );
														}
														else if ( type == CLEANUP )
														{
															element.removeAttribute( 'gspace' );
												...
												},
												{
													...
													setup : function( type, element )
													{
														if ( type == IMAGE )
														{
															var value,
																marginRgtPx,
																marginRgtStyle = element.getStyle( 'margin-right' );

															marginRgtStyle = marginRgtStyle && marginRgtStyle.match( pxLengthRegex );
															marginRgtPx = parseInt( marginRgtStyle, 10 );
															value = marginRgtPx;
															isNaN( parseInt( value, 10 ) ) && ( value = element.getAttribute( 'dspace' ) );
													...
													commit : function( type, element, internalCommit )
													{
														...
														if ( type == IMAGE || type == PREVIEW )
														{
															...
															if ( !internalCommit && type == IMAGE )
																element.removeAttribute( 'dspace' );
														}
														else if ( type == CLEANUP )
														{
															element.removeAttribute( 'dspace' );
