<div id="top-bar">
	<?php if(defined('PLUGIN_LOCALIZATION_ACTIV') && PLUGIN_LOCALIZATION_ACTIV) { $this->element(PLUGINS.DS.'localization'.DS.'views'.DS.'elements'.DS.'backoffice'.DS.'top_bar'); } ?>
	<ul>		
		<li class="nolink"><?php echo _("Bonjour"); ?> <?php echo Session::read("Backoffice.User.name"); ?></li>		
		<?php 
		if($nbFormsContacts > 0) { ?><li><a href="<?php echo Router::url('backoffice/contacts/index'); ?>"><?php echo $helpers['Html']->img('bo_godzilla/img/icon-message.png', array('alt' => _("Messages Internautes"))); ?> <?php echo _("Messages"); ?><span><?php echo $nbFormsContacts; ?></span></a></li><?php }
		if($nbPostsComments > 0) { ?><li><a href="<?php echo Router::url('backoffice/posts_comments/index'); ?>"><?php $helpers['Html']->img('bo_godzilla/img/icon-message.png', array('alt' => _("Commentaires Internautes"))); ?> <?php echo _("Commentaires articles"); ?><span><?php echo $nbPostsComments; ?></span></a></li><?php }
		...
		<li class="browse_website">
			...
			?>			
			<a href="<?php echo $wsUrl; ?>" target="_blank"><?php $helpers['Html']->img('bo_godzilla/img/website.png', array('alt' => _("Sites Internet"))); ?></a>
		</li>
		<li class="noborder">
			<?php			
		...
		<?php if(Session::getRole() == 1) { ?>
			<li>
				<?php echo $helpers['Html']->img('bo_godzilla/img/icon-settings.png', array('alt' => _("Settings"))); ?> <?php echo _("Configurations"); ?>
				<ul>
		...
		<li class="logout"><a href="<?php echo Router::url('users/logout'); ?>" title="Logout"><?php echo $helpers['Html']->img('bo_godzilla/img/logout.png', array('alt' => _("Déconnexion"))); ?></a></li>
	</ul>
</div>