	...
	<div id="types">
		<div class="content nopadding">
			...
			<div class="row" style="overflow:hidden;">
				<label>
					<?php $helpers['Html']->img('bo_godzilla/img/tooltip.png', array("original-title" => _("Cochez les types d'article (Plusieurs choix possibles)"), "class" => "tip-w", "style" => "float: left; margin-right: 5px; cursor: pointer;", "alt" => "tooltip")); ?>
					Type d'article
				</label>
				<div class="rowright">
					<?php 
...
<?php include_once(ELEMENTS.DS.'js'.DS.'buttons_right_column.php'); ?>