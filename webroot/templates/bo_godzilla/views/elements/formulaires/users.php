	...
	<div id="websites_users">
		<div class="content nopadding">
			<div class="row" style="overflow:hidden;">
				<label>
					<?php $helpers['Html']->img('bo_godzilla/img/tooltip.png', array("original-title" => _("Cochez le (ou les) site(s) que cet utilisateur peut administrer"), "class" => "tip-w", "style" => "float: left; margin-right: 5px; cursor: pointer;", "alt" => "tooltip")); ?>
