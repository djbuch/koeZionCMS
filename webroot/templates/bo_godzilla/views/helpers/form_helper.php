	...
	function upload_files($field, $params = null) {
		...
		<div class="row">
			<label>
				...
				<img original-title="<?php echo $params['tooltip']; ?>" class="tip-w" style="float: left; margin-right: 5px; cursor: pointer;" alt="tooltip" src="<?php echo BASE_URL; ?>/templates/bo_godzilla/img/tooltip.png">
			</label>
	...
	function upload_files_products() {
		...
		<div class="row">
			<label>
				...
				<img original-title="<?php echo _("Sélectionnez le fichier à importer"); ?>" class="tip-w" style="float: left; margin-right: 5px; cursor: pointer;" alt="tooltip" src="<?php echo BASE_URL; ?>/templates/bo_godzilla/img/tooltip.png">
			</label>
 ...
 */
	function radiobutton_templates($name, $value, $templateName, $templateLayout, $templateCode, $templateColor) {
		...
		if(file_exists($imgFile)) { $thumb = '<img src="'.BASE_URL.'/templates/bo_godzilla/img/templates/'.$templateLayout.'/'.$templateCode.'/background.png" />'; } 
