...
if(file_exists($aclsHelper)) { require_once($aclsHelper); } 
	 ...
	 */	
		public function backoffice_edit_picto($controller, $id, $action = 'edit', $css = '') {
			...
			return '<a href="'.Router::url('backoffice/'.$controller.'/'.$action.'/'.$id).'" class="'.$css.'"><img src="'.BASE_URL.'/templates/bo_godzilla/img/thumb-edit.png" alt="edit" /></a>';
		}		
	 ...
	 */	
		public function backoffice_delete_picto($controller, $id, $action = 'delete', $css = '') {
			...
			return '<a href="'.Router::url('backoffice/'.$controller.'/'.$action.'/'.$id).'" class="deleteBox '.$css.'" onclick="return confirm(\'Voulez vous vraiment supprimer?\');"><img src="'.BASE_URL.'/templates/bo_godzilla/img/thumb-delete.png" alt="delete" /></a>';
		}			
	 ...
	 */	
		public function backoffice_delete_button($controller, $css = '') {
			...
			<img src="'.BASE_URL.'/templates/bo_godzilla/img/arrow_top.png" />';
		}		
	 ...
	 */	
		public function backoffice_move2prev_picto($controller, $id, $action = "move2prev", $css = '') {
			...
			return '<a href="'.Router::url('backoffice/'.$controller.'/'.$action.'/'.$id).'" class="'.$css.'"><img src="'.BASE_URL.'/templates/bo_godzilla/img/up.png" alt="up" /></a>';
		}			
	 ...
	 */	
		public function backoffice_move2next_picto($controller, $id, $action = "move2next", $css = '') {
			...
			return '<a href="'.Router::url('backoffice/'.$controller.'/'.$action.'/'.$id).'" class="'.$css.'"><img src="'.BASE_URL.'/templates/bo_godzilla/img/down.png" alt="up" /></a>';
		}
	}
}