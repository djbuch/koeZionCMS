							...
							<div class="nivo-slider">
								<div class="slider-wrapper theme-default">
									<div id="nivoSlider" class="nivoSlider">
										<img src="<?php echo BASE_URL; ?>/templates/porto/img/slides/slide-1.jpg" data-thumb="<?php echo BASE_URL; ?>/templates/porto/img/slides/slide-1.jpg" alt="" />
										<img src="<?php echo BASE_URL; ?>/templates/porto/img/slides/slide-2.jpg" data-thumb="<?php echo BASE_URL; ?>/templates/porto/img/slides/slide-2.jpg" alt="" />
									</div>
						...
						<div class="row center">
							...
							<div class="col-md-2 col-md-offset-1">
								<div class="process-image" data-appear-animation="bounceIn">
									<img src="<?php echo BASE_URL; ?>/templates/porto/img/home-concept-item-1.png" alt="" />
									<strong>Strategy</strong>
								</div>
							</div>
							<div class="col-md-2">
								<div class="process-image" data-appear-animation="bounceIn" data-appear-animation-delay="200">
									<img src="<?php echo BASE_URL; ?>/templates/porto/img/home-concept-item-2.png" alt="" />
									<strong>Planning</strong>
								</div>
							</div>
							<div class="col-md-2">
								<div class="process-image" data-appear-animation="bounceIn" data-appear-animation-delay="400">
									<img src="<?php echo BASE_URL; ?>/templates/porto/img/home-concept-item-3.png" alt="" />
									<strong>Build</strong>
								</div>
							</div>
							<div class="col-md-4 col-md-offset-1">
								<div class="project-image">
									<div id="fcSlideshow" class="fc-slideshow">
										<ul class="fc-slides">
											<li><a href="portfolio-single-project.html"><img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/projects/project-home-1.jpg" /></a></li>
											<li><a href="portfolio-single-project.html"><img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/projects/project-home-2.jpg" /></a></li>
											<li><a href="portfolio-single-project.html"><img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/projects/project-home-3.jpg" /></a></li>
										</ul>
									</div>
				...
				<div class="container">
					...
					<div class="row center">
						<div class="owl-carousel" data-plugin-options='{"items": 6, "singleItem": false, "autoPlay": true}'>
							<div>
								<img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/logos/logo-1.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/logos/logo-2.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/logos/logo-3.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/logos/logo-4.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/logos/logo-5.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/logos/logo-6.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo BASE_URL; ?>/templates/porto/img/logos/logo-4.png" alt="">
							</div>
												...
												<div class="col-md-12">
													...
													<div class="testimonial-author">
														<div class="img-thumbnail img-thumbnail-small">
															<img src="<?php echo BASE_URL; ?>/templates/porto/img/clients/client-1.jpg" alt="">
														</div>
