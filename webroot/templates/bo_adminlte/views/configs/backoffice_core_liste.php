				    		...
				    		<div class="box-body">		
							    <div class="tab-content col-md-12">
							    	<div class="tab-pane active" id="general">	
										...
										<?php						
										echo $helpers['Form']->input('backoffice_template', _('Template de backoffice'), array('type' => 'select', 'datas' => array('bo_adminlte' => 'Godzilla', 'bo_metronic' => 'Metronic'), 'tooltip' => _("Sélectionnez le template BO")));
