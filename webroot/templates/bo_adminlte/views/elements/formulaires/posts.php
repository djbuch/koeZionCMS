				    ...
				    <div class="tab-content col-md-12">
				    	...
				    	<div class="tab-pane" id="diffusion">	
							...
							foreach($websitesSession['liste'] as $websiteId => $websiteName) {
								...
								echo $helpers['Form']->input('CategoriesPostsWebsite.'.$websiteId.'.display', _('Diffuser dans le site').' '.$websiteName, array('type' => 'checkbox', 'tooltip' => _("Cochez cette case pour diffuser cet article dans le site").' '.$websiteName, 'class' => 'display_on_website', 'checked' => $websitesSession['details'][$websiteId]['posts_display_by_default']));
