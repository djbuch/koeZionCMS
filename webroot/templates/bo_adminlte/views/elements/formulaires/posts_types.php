<div class="box box-primary">
	<div class="box-body">
		<div class="col-md-12">
			<?php
			echo $helpers['Form']->input('column_title', _('Titre de la colonne latérale'), array('compulsory' => true, 'tooltip' => _("Indiquez le titre qui sera affiché dans la colonne latérale")));
