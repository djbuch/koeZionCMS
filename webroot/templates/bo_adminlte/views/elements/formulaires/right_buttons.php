<div class="box box-primary">
	<div class="box-body">
		...
		echo $helpers['Form']->input('content',	_('Contenu'), array('type' => 'textarea', 'wysiswyg' => true, 'rows' => 5, 'cols' => 10, 'tooltip' => _("Saisissez ici le contenu de votre bouton, Pour les images ne pas dépasser 249px de largeur.")));
