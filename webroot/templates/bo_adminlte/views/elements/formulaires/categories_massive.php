...
echo $helpers['Form']->input('name_list', _('Titre'), array('type' => 'textarea', 'rows' => 5, 'cols' => 10, 'class' => 'xxlarge'));
...
//echo $helpers['Form']->input('content', 'Contenu', array('type' => 'textarea', 'rows' => 5, 'cols' => 10, 'wysiswyg' => true,  'tooltip' => "Saisissez ici le contenu de votre page, n'hésitez pas à utiliser les modèles de pages pour vous aider"));
