...
if($currentAction == 'index') { $pageTitle = _("Modules"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un module"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un module"); }
?>
