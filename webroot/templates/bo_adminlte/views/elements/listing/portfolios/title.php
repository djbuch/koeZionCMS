...
if($currentAction == 'index') { $pageTitle = _("Portfolios"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un portfolio"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un portfolio"); }
?>
