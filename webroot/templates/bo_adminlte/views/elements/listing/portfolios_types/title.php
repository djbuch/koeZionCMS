...
if($currentAction == 'index') { $pageTitle = _("Types de portfolios"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un type de portfolio"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un type de portfolio"); }
?>
