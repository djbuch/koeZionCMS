...
if($currentAction == 'index') { $pageTitle = _("Crawlers"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un crawler"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un crawler"); }
?>
