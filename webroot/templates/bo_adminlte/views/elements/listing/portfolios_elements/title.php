...
if($currentAction == 'index') { $pageTitle = _("Eléments de portfolios"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un éléments de portfolio"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un éléments de portfolio"); }
?>
