...
if($currentAction == 'index') { $pageTitle = _("Catégories"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter une catégorie"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer une catégorie"); }
?>
