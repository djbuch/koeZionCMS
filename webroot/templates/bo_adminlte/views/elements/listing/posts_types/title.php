...
if($currentAction == 'index') { $pageTitle = _("Types d'articles"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un type d'article"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un type d'article"); }
?>
