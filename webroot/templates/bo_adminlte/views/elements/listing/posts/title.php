...
if($currentAction == 'index') { $pageTitle = _("Articles (Blog)"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un article"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un article"); }
?>
