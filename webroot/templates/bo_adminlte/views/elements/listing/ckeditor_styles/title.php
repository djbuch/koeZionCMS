...
if($currentAction == 'index') { $pageTitle = _("Styles de l'éditeur de texte"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un style dans l'éditeur de texte"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un style dans l'éditeur de texte"); }
?>
