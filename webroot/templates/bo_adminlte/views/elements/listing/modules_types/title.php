...
if($currentAction == 'index') { $pageTitle = _("Type de modules"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un type de module"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un type de module"); }
?>
