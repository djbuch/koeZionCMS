...
if($currentAction == 'index') { $pageTitle = _("Templates"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un template"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un template"); }
?>
