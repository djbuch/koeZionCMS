...
if($currentAction == 'index') { $pageTitle = _("Commentaires articles"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un commentaire article"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un commentaire article"); }
?>
