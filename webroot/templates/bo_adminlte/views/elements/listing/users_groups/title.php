...
if($currentAction == 'index') { $pageTitle = _("Groupes d'utilisateurs"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un groupe d'utilisateur"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un groupe d'utilisateur"); }
?>
<section class="content-header">
	...
	<div class="page_menu" >
  		...
  		if($currentAction == 'index') { 
  			...
  			echo $helpers['Html']->backoffice_button_title('users', 'index', '<i class="fa fa-list-ul"></i>&nbsp;&nbsp;'._("Listing des utilisateurs"));
