...
if($currentAction == 'index') { $pageTitle = _("Modèles de page éditeur de texte"); } 
else if($currentAction == 'add') { $pageTitle = _("Ajouter un modèle de page éditeur de texte"); } 
else if($currentAction == 'edit') { $pageTitle = _("Editer un modèle de page éditeur de texte"); }
?>
