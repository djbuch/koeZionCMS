<?php if(isset($displayPosts) && $displayPosts) { ?>
	...
	<ul class="posts_list_element">
		...
		foreach($posts as $k => $v) { 
			...
			?>
			<li>
				<h2><a href="<?php echo $postUrl; ?>"><?php echo $v['name']; ?></a></h2>
				<p class="post_infos">
					<?php 
				...
				if($v['display_link']) { ?><p class="post_link"><a href="<?php echo $postUrl; ?>"><?php echo _('En savoir +'); ?></a></p><?php } 
				?>
			</li>
			<?php 
		} 
