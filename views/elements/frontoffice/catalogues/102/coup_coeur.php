	...
	<tbody>
		...
		<tr>			
			...
			<td>
				...
				<span class="color">Couleur : <?php echo $coupCoeur['color']; ?></span>
				<span class="containing">Contenant : <?php echo $coupCoeur['containing']; ?></span>
				<span class="origin">Origine : <?php echo $coupCoeur['origin']; ?></span>
