				...
				?>
					<table cellpadding="0" cellspacing="0">
						<tbody>
							...
							<tr>
								<td class="lib">Contenant :</td>
								<td><?php echo $helpers['Form']->input('containing', '', array('label' => false, 'div' => false, 'displayError' => false)); ?></td>
							</tr>
							<tr>
								...
								<td>
									...
									<?php echo $helpers['Form']->input('origin', '', array('label' => false, 'div' => false, 'displayError' => false)); ?>
								</td>
							</tr>
						</tbody>
					</table>	
