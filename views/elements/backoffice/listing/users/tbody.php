		...
		<tr>
			...
			<td>
				...
				if($role == 3 && $logUsersActiv) { 
					?><a href="<?php echo Router::url('backoffice/'.$params['controllerFileName'].'/logs/'.$v['id']); ?>"><img src="<?php echo BASE_URL; ?>/img/backoffice/users_log.png" alt="edit" style="float:right" /></a><?php 
				} 
				?>
			</td>
