<div style="border:1px solid #E5E5E5;margin-bottom:30px;" class="intern_search">
	...
	<div class="content nopadding" <?php if(isset($this->controller->request->data['Search'])) { ?>style="display:block;"<?php } ?>>	
		...
		echo $helpers['Form']->input('Search.layout', _('Layout'), array('tooltip' => ""));
		echo $helpers['Form']->input('Search.version', _('Version'), array('tooltip' => ""));
		echo $helpers['Form']->input('Search.code', _('Code'), array('tooltip' => ""));
