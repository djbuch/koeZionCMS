<tbody class="list_elements">
	<?php foreach($$params['controllerVarName'] as $k => $v): ?>
		<tr>			
			...
			<td class="txtcenter xs"><?php echo $v['name']; ?></td>
			<td class="auto_size_td"><a href="<?php echo Router::url('backoffice/'.$params['controllerFileName'].'/edit/'.$v['id']); ?>" class="edit_link"><?php echo $v['description']; ?></a></td>			
