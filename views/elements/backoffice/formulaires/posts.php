<div class="smarttabs nobottom">
	...
	<div id="general">
		...
		echo $helpers['Form']->input('dont_change_modified_date', 'Ne pas changer la date de modification', array('type' => 'checkbox', 'tooltip' => "Cochez cette case pour ne pas changer automatiquement la date de modification de l'article"));
