...
echo $helpers['Form']->input('message', 'Message', array('type' => 'textarea', 'wysiswyg' => true, 'toolbar' => 'empty', 'rows' => 5, 'cols' => 10, 'class' => 'xxlarge', 'tooltip' => "Insérez l'image à l'aide du module fournit par l'éditeur de texte, Taille 918/350px, Mode RVB, Résolution 72dpi")); 
