...
echo $helpers['Form']->input('display_home_mage', "Afficher sur la page d'accueil", array('type' => 'checkbox', 'tooltip' => "Cochez cette case pour afficher ce bouton sur la page d'accueil."));
