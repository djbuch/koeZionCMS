		...
		<div class="content">
			...
			if($pager['totalElements'] > 0) { 
				...
				<table cellspacing="0" cellpadding="0" border="0">					
					<?php $this->element('backoffice/listing/'.$this->vars['params']['controllerFileName'].'/thead'); ?>
					<?php $this->element('backoffice/listing/'.$this->vars['params']['controllerFileName'].'/tbody'); ?>
					<?php $this->element('backoffice/listing/'.$this->vars['params']['controllerFileName'].'/tfoot'); ?>					
				</table>
				<?php 
