...
<div class="section">
	<div class="half">
		...
		<div class="box">
			...
			<div class="content">
				<?php 
				if($nbFormsContacts > 0) { ?><p><?php echo $helpers['Html']->img('/backoffice/icon-message.png', array('alt' => _("Messages Internautes"))); ?> <a href="<?php echo Router::url('backoffice/contacts/index'); ?>" class="basic_link"><?php echo _("Vous avez"); ?> <?php echo $nbFormsContacts; ?> <?php echo _("messages d'internautes non lus"); ?></a></p><?php }
				else { ?><p><?php echo _("Aucun nouveau message d'Internaute"); ?></p><?php }
				if($nbPostsComments > 0) { ?><p><?php echo $helpers['Html']->img('/backoffice/icon-message.png', array('alt' => _("Commentaires Internautes"))); ?> <a href="<?php echo Router::url('backoffice/posts_comments/index'); ?>" class="basic_link"><?php echo _("Vous avez"); ?> <?php echo $nbPostsComments; ?> <?php echo _("commentaires d'internautes non validés"); ?></a></p><?php } 
