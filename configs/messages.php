...
$Errorsmessages['Color']['name'] = _('La valeur de ce champ est de 2 caractères minimum.');
$Errorsmessages['Color']['layout'] = _('La valeur de ce champ est de 2 caractères minimum.');
...
$Errorsmessages['Locale']['code'] = _('La valeur de ce champ est de 2 caractères.');
$Errorsmessages['Locale']['url'] = _('Vous devez saisir une url valide.');
