...
INSERT INTO `users` (`id`, `company_name`, `company_role`, `lastname`, `firstname`, `phone`, `mobile`, `email`, `password`, `date_of_birth`, `facebook_id`, `facebook_link`, `facebook_locale`, `activate_price_ranges`, `low_price`, `high_price`, `filter_by_price`, `online`, `created`, `modified`, `customers_type_id`, `users_group_id`) VALUES
