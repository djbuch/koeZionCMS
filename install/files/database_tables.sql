...
CREATE TABLE IF NOT EXISTS `websites` (
  ...
  `txt_mail_contact` text COLLATE utf8_unicode_ci NOT NULL,
  `txt_mail_comments` text COLLATE utf8_unicode_ci NOT NULL,
  `txt_mail_newsletter` text COLLATE utf8_unicode_ci NOT NULL,  
