...
<div class="box box-primary">
	<div class="box-header bg-light-blue">
		<h4><i class="fa fa-folder-open"></i> <?php echo _("IMPORT DES DONNEES DANS LES TABLES"); ?></h4>                  
	</div>    		
	<?php if($init_db_tables['result']) { ?>		
		<div class="box-body">
			<table class="table table-bordered">
				...
				<tr>
					<td>% progression</td>
					<td colspan="3" class="text-right"><?php echo $init_db_tables['datas']['pct_bar']; ?></td>
				</tr>				
			</table>
		</div>
		<div class="box-footer"> 
			<form action="index.php?step=website" method="post">
				<button class="btn btn-primary btn-flat pull-right" type="submit"><?php echo _('Configuration du site Internet'); ?></button>
			</form>
		</div>
	<?php } else { ?>
		<div class="box-body">
